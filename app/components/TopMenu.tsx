...
export default function TopMenu() {
    ...
    return (
        <nav className="text-gray-800 bg-gray-200/20 shadow relative z-10 px-4 sm:px-0">
            <ul className="flex gap-8 justify-center py-4 max-w-screen-md mx-auto w-full">
                {navLinks.map(link => (
                    <li key={link.href}>
                        <Link
                            href={link.href}
